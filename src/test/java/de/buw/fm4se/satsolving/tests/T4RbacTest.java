...
public class T4RbacTest {
  ...
  void testRules() {
    ...
    assertTrue(formula_r1_without_whitespace.contains(r1)||formula_r2_without_whitespace.contains(r1)||formula_r3_without_whitespace.contains(r1), "Rule 1 is wrong or does not using the right atoms.");
    assertTrue(formula_r1_without_whitespace.contains(r2)||formula_r2_without_whitespace.contains(r2)||formula_r3_without_whitespace.contains(r2), "Rule 2 is wrong or does not using the right atoms.");
    assertTrue(formula_r1_without_whitespace.contains(r3)||formula_r2_without_whitespace.contains(r3)||formula_r3_without_whitespace.contains(r3), "Rule 3 is wrong or does not using the right atoms.");
  }
